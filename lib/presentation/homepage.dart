...
final timeProvider = ChangeNotifierProvider<TimeProvider>((ref) {
  ref.read(dataProvider).getWorkTime();
  var data = ref.read(dataProvider);
  return TimeProvider(data.startTime);
});

class HomePage extends ConsumerStatefulWidget {
  const HomePage({Key? key, required this.startTime}) : super(key: key);
